...
1. **Add the server**
   ...
   **Server → Connect → Add New**, then:

   - **Address:** `cytonicmushroom.ddns.net`
   - **Port:** `64738`
   - **Username:** whatever you want to show up as

   Accept the server certificate when prompted, and connect.
